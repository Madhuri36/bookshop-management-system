...
++++++++++++++++++++++++++    MY BOOKSTORE     +++++++++++++++++++++++++
==========================================================================""")
                mycursor.execute("create table if not exists Available_Books(BookName varchar(30) primary key,Genre varchar(20),Quantity int(3),Author varchar(20),Publication varchar(30),Price varchar(30))")
                mycursor.execute("create table if not exists Sell_rec(CustomerName varchar(20),PhoneNumber char(10) unique key, BookName varchar(30),Quantity int(100),Price varchar(4),foreign key (BookName) references Available_Books(BookName))")
                ...
                while(True):
                    ...
                    print("7:Total Income after Purchase ")
                    print("8:Exit")
                    ...
                    if a==1:
                        ...
                        for i in price:
                            if(i.isdigit()==True):
                                ...
                                print("Invalid Price, Please enter an integral value!")
                                exit()
